          ...
          <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form  method="POST" action="{{route('worker.update', $data[0]->id)}}">
                            @method('PUT')
                            {{ csrf_field() }}
                            <div class="card-body">
                                    <div class="form-group fli col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <label for="exampleInputEmail1">Sheet Name</label>
                                    <input type="text" class="form-control" id="name" value="{{$data[0]->name}}" name="name" placeholder="Sheet Name">
                                    </div>
                                    <div class="form-group fli col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <div class="form-group fli col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        <input type="text" class="form-control" id="price" value="{{$data[0]->price}}" name="price" placeholder="price">
                                    </div>
                                    <div class="form-group fli col-lg-6 col-md-6 col-sm-12 col-xs-12">
