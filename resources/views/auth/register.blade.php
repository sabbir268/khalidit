                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('member.register') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="study" class="text-md-right">{{ __('Study') }}</label>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="ssc_batch" type="text"
                                    class="form-control @error('ssc_batch') is-invalid @enderror" name="ssc_batch"
                                    value="{{ old('ssc_batch') }}" required autocomplete="ssc_batch">
                            ...
                            <div class="form-group col-md-6">
                                <label for="doc" class="text-md-right">Upload Curriculum Vitae</label>
